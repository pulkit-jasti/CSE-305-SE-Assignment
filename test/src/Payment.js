              ...
              <div class="row d-flex justify-content-center pb-5">
                    ...
                    <div class="py-4 d-flex flex-row">
                      <div class="card mb-3">
                        <div class="row g-0">
                          <div class="col-md-4">
                            <img
                              src="https://cdn-icons-png.flaticon.com/512/489/489870.png"
                              class="img-fluid rounded-start"
                              alt="..."
                            />
                          </div>
                          <div class="col-md-8">
                            <div class="card-body">
                              ...
                              <br></br>
                              <p> </p>
                              <h2 class="card-title">R000oom Details</h2>
                            </div>
                          </div>
                          <hr></hr>
                          <div class="col-md-12">
                ...
                <div class="col-md-5 col-xl-4 offset-xl-1" style={{ marginLeft: "-110px" }}>
                  ...
                  <div class="rounded d-flex flex-column p-2" style={{ backgroundColor: "#f8f9fa;" }}>
                    ...
                    <button type="submit" class="btn btn-warning" onClick={getEmployees}>
                ...
                {roomList.map((item, index) => (
                  <div class="col-md-5 col-xl-4 offset-xl-1">
                    ...
                    <div class="rounded d-flex flex-column p-2" style={{ backgroundColor: "#f8f9fa;" }}>
                      ...
                      <div class="p-2 d-flex">
                        <div class="col-8">SGST (Taxes)</div>
                      ...
                      <div class="p-2 d-flex pt-3">
                        ...
                        <div class="ms-auto">
                          <b class="text-success">{item.Room_price + 450}.00</b>
                        </div>
                      </div>
                    </div>
                  </div>
