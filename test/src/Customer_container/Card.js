...
const Card = () => {
  const links = [
    ...
    "https://dq5r178u4t83b.cloudfront.net/wp-content/uploads/sites/115/2020/08/20094748/spa-4.jpg",
    "https://imgmedia.lbb.in/media/2018/11/5c016875d7a5832ac34d51be_1543596149373.jpg",
  ];
  /*
  ...
  return (
    <div style={{ marginBottom: "50px", marginTop: "50px" }} className="home">
      <center>
        <hr></hr>
            ...
            <div className="row row-cols-1 row-cols-md-4 g-3">
              ...
              <div className="col-md-4">
                <div className="card room-card h-100">
                  <img
                    style={{ width: "500px", height: "300px" }}
                    src="https://dq5r178u4t83b.cloudfront.net/wp-content/uploads/sites/115/2020/08/20094748/spa-4.jpg"
                    class="img-fluid img-thumbnail"
                    alt="..."
                  ></img>
                  <div className="card-body">
              ...
              <div className="col-md-4">
                <div className="card room-card h-100">
                  <img
                    style={{ width: "500px", height: "300px" }}
                    src="https://imgmedia.lbb.in/media/2018/11/5c016875d7a5832ac34d51be_1543596149373.jpg"
                    class="img-fluid img-thumbnail"
                    alt="..."
                  ></img>
                  <div className="card-body">
